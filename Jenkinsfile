pipeline {
  ...
  stages {
    ...
    stage ('DEV Tomcat Deploy') {
      ...
      deploy adapters: [tomcat9(credentialsId: '4df4a1f9-b7c5-45e8-a180-bea3df38f7a5', path: '', url: 'http://ec2-3-88-174-218.compute-1.amazonaws.com:8080/')], contextPath: null, war: '**/*.war'
      }
    }
